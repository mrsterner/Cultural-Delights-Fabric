...
public class CDObjects {
    ...
    public static final Item HEARTY_SALAD = register("hearty_salad", new BowlFoodItem(settings().food(CDFoodComponents.HEARTY_SALAD)));
    ...
    public static final Item FRIED_EGGPLANT_PASTA = register("fried_eggplant_pasta", new BowlFoodItem(settings().food(CDFoodComponents.FRIED_EGGPLANT_PASTA)));
    ...
    public static final Item CREAMED_CORN = register("creamed_corn", new BowlFoodItem(settings().food(CDFoodComponents.CREAMED_CORN)));
    ...
    public static final Item CUCUMBER_SEEDS = register("cucumber_seeds", new ItemNameBlockItem(CUCUMBER_CROP ,settings()));
    public static final Item CORN_KERNELS = register("corn_kernels", new ItemNameBlockItem(CORN_CROP, settings()));
    public static final Item EGGPLANT_SEEDS = register("eggplant_seeds", new ItemNameBlockItem(EGGPLANT_CROP, settings()));
    ...
    private static <T extends Block> T register(String name, T block, Item.Properties settings, boolean createItem) {
